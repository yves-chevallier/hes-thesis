...
%// @file     javascript.tex                                                    
%// @language ASCII/C                                                           
%// @svn      $Id: javascript.tex 82 2005-12-14 05:41:51Z Canard $              
%///////////////////////////////////////////////////////////////////////////////
...
\begin{leftbar}\begin{verbatim}o www.google.ch 80\end{verbatim}
\end{leftbar}
...
\begin{leftbar}\begin{verbatim}GET www.google.ch/ HTTP/1.0\end{verbatim}
\end{leftbar} 
...
\begin{leftbar}\begin{verbatim}HTTP/1.0 200 OK
...
\begin{leftbar}\begin{verbatim}GET www.google.ch/search?q=lontouch  HTTP/1.0\end{verbatim}
\end{leftbar} 
...
\begin{leftbar}\begin{verbatim}GET www.lontouch.ch/snvt?value=128&state=1  HTTP/1.0\end{verbatim}
\end{leftbar}  
...
\begin{leftbar}\begin{verbatim}GET www.lontouch.ch/snvt?lamp1.value=128&lamp1.state=1  HTTP/1.0\end{verbatim}
\end{leftbar}         
...
\begin{leftbar}\begin{verbatim}GET www.lontouch.ch/snvt?update  HTTP/1.0\end{verbatim}
\end{leftbar}         
...
\begin{leftbar}\begin{verbatim}var toto = 4\end{verbatim}
\end{leftbar} 
...
\begin{leftbar}\begin{verbatim}var toto = {tata:4, titi:5}\end{verbatim}
\end{leftbar} 

Ce format, simple, peut être appliqué à des structures SNVT comme le montre l'exemple suivant pour un type switch: 

\begin{leftbar}\begin{verbatim}lamp1 = {state: 1, value: 130}\end{verbatim}
\end{leftbar}                                             
...
\begin{leftbar}\begin{verbatim}GET www.lontouch.ch/snvt.js?update  HTTP/1.0\end{verbatim}
\end{leftbar}                                             

A titre d'information, voici ce que nous aurions reçu pour un format XML (\texttt{GET www.lontouch.ch/snvt.xml?update  HTTP/1.0})

\begin{leftbar}\begin{verbatim}<snvt type="switch" name="lamp1">
<value>128</value>
 	<state>1</state>
</snvt>\end{verbatim}
\end{leftbar}
...
\begin{leftbar}\begin{verbatim}bouton1.State(1)
bouton1.Value(100)\end{verbatim}
\end{leftbar}

Réciproquement, si l'on souhaite affecter à une variable toto la valeur 55 on procédera de cette manière:

\begin{leftbar}\begin{verbatim}var toto = bouton1.State()\end{verbatim}
\end{leftbar}             
...
\begin{leftbar}\begin{verbatim}bouton1.EventCSS('classOverOn', "couleur_vert_clair")
bouton1.EventCSS('classOverOff', "couleur_rouge_clair")
bouton1.EventCSS('classOutOn', "couleur_vert")
bouton1.EventCSS('classOutOff', "couleur_rouge")\end{verbatim}
\end{leftbar}             
...
\begin{leftbar}\begin{verbatim}bouton1.Event('onclick', "alert('vous venez de cliquez sur un contrôle de type SNVT switch')")\end{verbatim}
\end{leftbar} 
...
\subsection{Aperçu des possibilités pour un contrôle de type SNVT\_switch}
